...
public class Donkey extends PackAnimal {
    ...
    public Donkey(String type, String name, Date birthday, ArrayList<String> commands, Double bearingForce,
            String stock) {
        super(type, name, birthday, commands, bearingForce);
        this.stock = stock;
    }

    public Donkey(String type, String id, String name, Date birthday, ArrayList<String> commands, Double bearingForce,
            String stock) {
